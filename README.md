...
- O segundo algoritmo foi desenvolvido usando unigram, bigram e trigram taggers, que foram treinados com as normalizações como "etiquetas" das palavras OOV, enquanto as palavras que não deveriam ser normalizadas receberam uma etiqueta vazia. 
